...
from fpl_predictor.team import PositionFilled, AlreadySelected, MaxedOutTeam


class Optimized(TeamBuilder):
    ...
    def optimize(self):
        ...
        old_score = self.team.total_raw_score
            ...
            if len(better_perms):
                for row_j in better_perms.iterrows():
                    ...
                    try:
                        ...
                        new_score = test.team.total_raw_score
